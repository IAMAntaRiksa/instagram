...
import 'package:instagram/model/account.dart';

class PostFedd extends StatelessWidget {
  const PostFedd({Key? key, required this.usersAccount}) : super(key: key);
  final Account usersAccount;
  @override
        ...
        Container(
          ...
          child: Row(
            children: [
              Container(
                child: CircleAvatar(
                  child: ClipOval(child: Image.asset('assets/avatars/new.png')),
                ),
              ),
              Expanded(
                child: TextField(
